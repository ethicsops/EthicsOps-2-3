...
class AccountVC : UITableViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        themeTextFieldWithText(nameTextField, text: "Jeremy Ducote")
        
        themeLabelWithText(locationLabel, text: "LOCATION")
        themeTextFieldWithText(locationTextField, text: "Lafayette, LA")

        themeLabelWithText(emailLabel, text: "EMAIL")
        themeTextFieldWithText(emailTextField, text: "jeremy@momentumbi.com")
    ...
    func registerForKeyboardNotifications ()-> Void   {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(AccountVC.keyboardWasShown(_:)), name: UIKeyboardDidShowNotification, object: nil)
        
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(AccountVC.keyboardWillBeHidden(_:)), name: UIKeyboardWillHideNotification, object: nil)
    }
