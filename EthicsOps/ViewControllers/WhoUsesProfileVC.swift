...
class WhoUsesProfileVC: UITableViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    var person: Person? //Current person
    var personArray: [Person] = [] //Entire array for viewing next person
    var personIndex = 0 //Current person's index in array
    ...
    func updatePersonDetails() {
        ...
        productCollectionView.contentOffset = CGPointMake(0, 0)
    }
...
//    }
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        if collectionView == productCollectionView {
            ...
            let photo = person!.comics[indexPath.row].imageName
    ...
    func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        if indexPath.row == person!.comics.count-1 {
    ...
    func nextPerson() {
        if personIndex < personArray.count-1 {
            personIndex += 1
            person = personArray[personIndex]
            updatePersonDetails()
        } else {
            let alertController = UIAlertController(title: "Oops!", message:
                "There are no more people to view.", preferredStyle: UIAlertControllerStyle.Alert)
